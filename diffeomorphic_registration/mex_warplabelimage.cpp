               ...
               const mxArray *prhs[])
{
   ...
   typedef typename itk::NearestNeighborInterpolateImageFunction<ImageType,CoordRepType> InterpolatorType;
   //boost::timer timer;
                 ...
                 const mxArray *prhs[])
{
   ...
   case 2:
      ...
      {
         case mxSINGLE_CLASS:    
            warplabelimage<float,2>(nlhs, plhs, nrhs, prhs);
            break;
         case mxDOUBLE_CLASS:
            warplabelimage<double,2>(nlhs, plhs, nrhs, prhs);
            break;
         default:
   ...
   case 3:
      ...
      {
         case mxSINGLE_CLASS:    
            warplabelimage<float,3>(nlhs, plhs, nrhs, prhs);
            break;
         case mxDOUBLE_CLASS:
            warplabelimage<double,3>(nlhs, plhs, nrhs, prhs);
            break;
         default:
            mexErrMsgTxt("Pixel type unsupported.");
      }
